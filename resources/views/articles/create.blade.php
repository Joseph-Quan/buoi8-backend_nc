...
@section('title', 'Viết bài viết mới') 
...
<div class="row justify-content-center"> 
    <div class="col-lg-8"> 
        ...
        <div class="d-flex justify-content-between align-items-center mb-4"> 
            <div>
                <h1 class="h3 fw-bold mb-1">✏ Tạo bài viết mới (Articles)</h1> 
                <p class="text-muted mb-0">Chia sẻ kiến thức bổ ích của bạn với cộng đồng</p>
            </div>
